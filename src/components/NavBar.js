...
const CustomMobileLink = ({ href, title, className="", toggle }) => {
    ...
    return (
        <button href={href} className={`${className} font-semibold text-lg relative group text-light dark:text-dark my-2`} onClick={handleClick}>
            {title}
        ...
        className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                <nav>
                    ...
                    {/* <CustomLink href='/musings' title="Musings" className="mx-4"/> */}
                </nav>
...

            {
                ...
                <motion.div
                    ...
                    <nav className="flex items-center flex-col justify-center">
                        ...
                        <CustomMobileLink href='/musings' title="Musings" className="" toggle={handleClick} />
                    </nav>
                    ...
                    <nav className="flex items-center justify-center flex-wrap mt-2">
                        ...
                        >
                            {
                                mode === "dark" ? 
                                <SunIcon className={"fill-light dark:fill-dark"} />
                                : <MoonIcon className={"fill-light dark:fill-dark"}/>
                            }
                        </button>
                    </nav>
                </motion.div>
            ...
            <div className="absolute left-[50%] top-2 z-5 translate-x-[-50%]">
                <Logo />
            </div>
        </header>
    );
